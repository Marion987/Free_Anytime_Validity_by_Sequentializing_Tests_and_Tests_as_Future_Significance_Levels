#Simulation for Section 5.1 "Define a new test to get an earlier decision" from the Bachelor Thesis
#plot the time we stop for z-tests with gluing to get a decisions
#i.e. If the seq. z-test reaches the threshold, we define a new test based on then next 15 data points to get a decision
